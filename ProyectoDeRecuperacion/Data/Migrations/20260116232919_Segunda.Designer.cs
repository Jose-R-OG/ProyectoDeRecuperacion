...
namespace ProyectoDeRecuperacion.Migrations
{
    ...
    [Migration("20260116232919_Segunda")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoDeRecuperacion.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProyectoDeRecuperacion.Models.Entrada", b =>
                {
            ...
            modelBuilder.Entity("ProyectoDeRecuperacion.Models.EntradaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoDeRecuperacion.Models.Productos", b =>
                {
                    b.Property<int>("ProductoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProyectoDeRecuperacion.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProyectoDeRecuperacion.Models.EntradaDetalle", b =>
                {
                    b.HasOne("ProyectoDeRecuperacion.Models.Entrada", null)
                        .WithMany("Detalles")
